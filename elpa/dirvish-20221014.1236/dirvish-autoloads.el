...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-collapse" '("dirvish-collapse--cache")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-emerge" '("dirvish-emerge-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-icons" '("dirvish-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-ls" '("dirvish-ls-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-narrow" '("dirvish-narrow-")))
...
If called interactively, enable Dirvish-Side-Follow mode if ARG
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dirvish-vc" '("dirvish-vc-")))
